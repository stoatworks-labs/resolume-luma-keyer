...
**[v1.3.1](https://github.com/stoatworks-labs/resolume-luma-keyer/releases/tag/v1.3.1)** — prebuilt for macOS and Windows. Pick your platform:
...
| Build | Download | Size |
| --- | --- | --- |
| Universal (Apple Silicon + Intel) · .dmg disk image | [`luma-key-1.3.1-macos-universal.dmg`](https://github.com/stoatworks-labs/resolume-luma-keyer/releases/download/v1.3.1/luma-key-1.3.1-macos-universal.dmg) | 187 KB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .exe installer | [`luma-key-1.3.1-windows-x86_64-setup.exe`](https://github.com/stoatworks-labs/resolume-luma-keyer/releases/download/v1.3.1/luma-key-1.3.1-windows-x86_64-setup.exe) | 204 KB |
