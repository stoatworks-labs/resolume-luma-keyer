...
**[v1.3.6](https://github.com/stoatworks-labs/resolume-luma-keyer/releases/tag/v1.3.6)** — prebuilt for macOS, Windows and Linux. Pick your platform:
...
| Build | Download | Size |
| --- | --- | --- |
| Universal (Apple Silicon + Intel) · .dmg disk image | [`luma-key-1.3.6-macos-universal.dmg`](https://github.com/stoatworks-labs/resolume-luma-keyer/releases/download/v1.3.6/luma-key-1.3.6-macos-universal.dmg) | 180 KB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .exe installer | [`luma-key-1.3.6-windows-x86_64-setup.exe`](https://github.com/stoatworks-labs/resolume-luma-keyer/releases/download/v1.3.6/luma-key-1.3.6-windows-x86_64-setup.exe) | 207 KB |
